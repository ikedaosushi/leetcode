import pytest
from getIntersectionNode import Solution
...
@pytest.mark.parametrize("nums_a,nums_b,nums_a_idx,nums_b_idx", [
    (
        [4, 1, 8, 4, 5], [5, 0, 1, 8, 4, 5], 2, 3
    ),
    (
        [4, 1, 8, 4, 5], [5, 0, 1, 8, 5, 5], None, None
    )
])
def test_getIntersectionNode(nums_a, nums_b, nums_a_idx, nums_b_idx):
